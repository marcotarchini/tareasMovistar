...
$(function () {
  ...
  function closeDisponibilidad() {
    //$('.js-formulario-movil-cerrado').hide(),
    //$('.js-loquiero-movil-cerrado').show(),
    //$('.js-loquiero-mobile').hide(),
  ...
  function continuar() {
    ...
    var a = localStorage.getItem('ani');
    null != a && '' != a && 'empty' != a ? sendPin() : ($('.modal').modal('hide'), $('#planIdeal2').modal('show'));
  }
  ...
  function autoCargaDeANI() {
    var a = !1,
      b = '; ' + document.cookie,
      c = b.split('; msisdn=');
    2 == c.length && (a = c.pop().split(';').shift()),
      (a = !!a && a.substr(a.length - 10)),
      a
        ? (dataLayer.push({
            event: 'LinkClickAction',
            eventCategory: 'ctc',
          ...
          0 == $('.cod-urb').length
            ? ($('.anictc.form-control').val(a), $('.tel_number').val(a), console.log(a))
            : ('11' == a.substr(0, 2)
                ? ($('.cod-urb').val('11'), $('.anictc.num.flex').val(a.substr(2, 8)), $('.anictc.form-control').val(a))
                : ($('.cod-urb').val(a.substr(0, 3)),
                  $$ery('.anictc.num.flex').val(a.substr(3, 7)),
                  $('.anictc.form-control').val(a)),
              $('.tel_number').val(a),
              console.log(a)))
        : console.log('no hay msisdn autocarga');
  }
  ...
  function validarTel(a, b, c) {
    for (var d = 99, e = '', f = '', g = 0; 0 == g; g++) {
      ...
      if (10 != a.length) {
        b.find('label.error-disclaimer').hide(),
          b.find('label.error').addClass('red'),
          b.find('label.error').text('El n\xFAmero debe tener 10 caracteres (por ejemplo: 11 49999999)'),
          (d = 3),
      ...
      if (!(null == c || 0 > jQuery.inArray(h, c.split('|')))) {
        b.find('label.error-disclaimer').hide(),
          b.find('label.error').addClass('red'),
          b.find('label.error').text('N\xFAmero ya registrado. El n\xFAmero fue ingresado previamente.'),
          (d = 6),
  ...
  function callService(a) {
    ...
    'CERRADO' == estadoCallCenterMovil && ('Movil' == tipo_lp || 'Fija' == tipo_lp) && (f = '' + f),
  ...
  $('.menu-tab').on('shown.bs.tab', function (a) {
    ...
    $(document).on(
      'click',
      '*[data-target="#modal"],*[data-target="#modalDisponibilidad"],*[data-target="#modalDisponibilidadPlanFibra50MB"]',
      function (a) {
        var b,
    ...
    $(document).on('click', _dataTargetModalNewFlow, function () {
      ...
      $(this).attr('data-cod-campana') !== void 0 && (b = $(this).attr('data-cod-campana')),
        ...
        $(this).attr('data-valor-origen') && $(_modalNewFlow).find('.orig').val($(this).attr('data-valor-origen')),
        $('.js-click-cambio').each(function () {
    ...
    $('#confirm-btn').on('click', function (a) {
      if (
        ...
        var b = $('#ani').val();
        'empty' != b && '' != b ? sendForm() : ($('.modal').modal('hide'), $('#planIdeal2').modal('show'));
    ...
    $(document).on('click', '.js-click-cambio-banner', function (a) {
      ...
      $('.js-mainBanner:visible .camp').val(b),
        ...
        $('.tabsNav.active').hasClass('carrusel')
          ? callService($('.tabsNav.active .item.active .js-mainBanner:visible .form-group .sendGTM'))
