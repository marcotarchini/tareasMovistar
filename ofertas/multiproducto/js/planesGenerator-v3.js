        ...
        if (planesJson[b].ID === jsonDataContenedor[a]) {
          ...
          0 < c.getElementsByClassName('js-plan-descuentomayor-producto').length
            ? (c.getElementsByClassName(
                'js-plan-descuentomayor-producto',
              )[0].innerHTML = mayorDescuento(planesJson[b].Producto))
            : null,
            ...
            0 < c.getElementsByClassName('js__plan-precio-de-lista').length
              ? ((c.getElementsByClassName('js__plan-precio-de-lista')[0].innerHTML =
                  planesJson[b]['Precio de Lista']),
                (c.getElementsByClassName('js__plan-precio-de-lista')[0].parentNode.style.display =
                  'block'))
              : null,
            planesJson[b]['Precio de Lista'] !== void 0 &&
            '' !== planesJson[b]['Precio de Lista'] &&
            0 < c.getElementsByClassName('js__plan-precio-de-lista-toggle').length
              ? (c.getElementsByClassName('js__plan-precio-de-lista-toggle')[0].style.display =
                  'inline')
              : null,
            planesJson[b]['Precio de Lista'] !== void 0 &&
            '' !== planesJson[b]['Precio de Lista'] &&
            0 < c.getElementsByClassName('js__plan-precio-vigente-descuento').length
              ? (c.getElementsByClassName('js__plan-precio-vigente-descuento')[0].style.display =
                  'inline')
              : null,
            0 < c.getElementsByClassName('js__plan-descuento').length &&
              ('' === planesJson[b]['% OFF']
                ? c.getElementsByClassName('js__plan-descuento')[0].parentNode.remove()
                : (c.getElementsByClassName('js__plan-descuento')[0].innerHTML =
                    planesJson[b]['% OFF'])),
            0 < c.getElementsByClassName('singlePlanMigracionesToggle').length &&
            '' === planesJson[b]['% OFF']
            ...
            0 < c.getElementsByClassName('js__plan-promedio-descuento-portabilidad').length
              ? (c.getElementsByClassName(
                  'js__plan-promedio-descuento-portabilidad',
                )[0].innerHTML = promedioDescuento('Portabilidad'))
              : null,
            0 < c.getElementsByClassName('js__plan-capacidad-unidad').length
              ? (c.getElementsByClassName('js__plan-capacidad-unidad')[0].innerHTML =
            ...
            '' !== planesJson[b]['Precio Oferta']
              ...
              : null,
            0 < c.getElementsByClassName('js__nuevo-precio').length
              ? (c.getElementsByClassName('js__nuevo-precio')[0].innerHTML = j(
                  parseInt(planesJson[b]['Nuevo Precio'].slice(0, -3)),
                ))
              : null,
            0 < c.getElementsByClassName('js__plan-precio-oferta').length &&
            '' === planesJson[b]['Precio Oferta'] &&
            ...
            0 < c.getElementsByClassName('js__plan-gigas').length
              ? (c.getElementsByClassName('js__plan-gigas')[0].innerHTML = planesJson[b][
                  'Capacidad Plan'
                ].replace('.', ','))
              : null,
            0 < c.getElementsByClassName('js__plan-nombre').length
              ? (c.getElementsByClassName('js__plan-nombre')[0].innerHTML =
                  planesJson[b]['Nombre Plan'])
              : null,
            0 < c.getElementsByClassName('js__plan-pocode').length
              ? (c.getElementsByClassName('js__plan-pocode')[0].href = planesJson[b]['Pocode'])
              : null,
            0 < c.getElementsByClassName('js__plan-duracion').length
              ? (c.getElementsByClassName('js__plan-duracion')[0].innerHTML =
                  planesJson[b].Duración)
              : null,
            'Si' === planesJson[b]['Promo Hotsale'] &&
            0 < c.getElementsByClassName('js__plan-hotsale').length
          ...
          0 < c.getElementsByClassName('js__movistar-play').length
            ...
            0 >= c.getElementsByClassName('js__movistar-play').length
              ? (c.getElementsByClassName('js__pasa-gigas-novedad')[0].style.display = 'block')
              : null,
            'Si' === planesJson[b].CyberMonday &&
            0 < c.getElementsByClassName('js__plan-cyberMonday').length
              ? ((c.getElementsByClassName('js__plan-cyberMonday')[0].style.visibility = 'visible'),
                (c.getElementsByClassName('js__plan-cyberMonday')[0].src =
                  'images/global/cybermonday.png'))
              : null,
            'Si' === planesJson[b].CyberWeek &&
            0 < c.getElementsByClassName('js__plan-cyberWeek').length
              ? ((c.getElementsByClassName('js__plan-cyberWeek')[0].style.visibility = 'visible'),
                (c.getElementsByClassName('js__plan-cyberWeek')[0].src =
                  'images/global/cyberweek.png'))
              : null,
            'Si' === planesJson[b]['Sticker Exclusivo Promo online Banner'] &&
            0 < c.getElementsByClassName('js__plan-promoExclusivaOnline').length
              ? ((c.getElementsByClassName('js__plan-promoExclusivaOnline')[0].style.visibility =
                  'visible'),
            ...
            0 < c.getElementsByClassName('js__plan-promoExclusivaOnlineNew').length
              ? (c.getElementsByClassName('js__plan-promoExclusivaOnlineNew')[0].style.visibility =
                  'visible')
              : null,
            '' !== planesJson[b]['Pasa Gigas Banner Sticker'] &&
            'No' !== planesJson[b]['Pasa Gigas Banner Sticker']
              ? 'No' !== planesJson[b]['Amazon Prime'] &&
                '' !== planesJson[b]['Amazon Prime'] &&
                0 < c.getElementsByClassName('js__plan-primeVideo').length
                ? ((c.getElementsByClassName('js__plan-primeVideo')[0].style.visibility =
                    'visible'),
                  (c.getElementsByClassName('js__plan-primeVideo')[0].src =
                    'images/global/pasagigas.png'))
                : null
              : 'No' !== planesJson[b]['Amazon Prime'] &&
                '' !== planesJson[b]['Amazon Prime'] &&
              ...
              ? ((c.getElementsByClassName('js__plan-primeVideo')[0].style.visibility = 'visible'),
                (c.getElementsByClassName('js__plan-primeVideo')[0].src =
                  'images/global/porta-planes-cuca.png'))
              : null,
            'No' !== planesJson[b]['Amazon Prime'] &&
            '' !== planesJson[b]['Amazon Prime'] &&
            0 < c.getElementsByClassName('js__plan-AmazonPrime').length
              ? ((c.getElementsByClassName('js__plan-AmazonPrime')[0].style.display = 'block'),
                (c.getElementsByClassName('js__plan-primeVideoMeses')[0].innerHTML =
                  planesJson[b]['Amazon Prime']),
                'No' === planesJson[b]['Amazon Prime Precio']
                  ? null
            ...
            0 < c.getElementsByClassName('js__plan-blackFriday').length
              ? ((c.getElementsByClassName('js__plan-blackFriday')[0].style.visibility = 'visible'),
                (c.getElementsByClassName('js__plan-blackFriday')[0].src =
                  'images/global/blackfriday.png'))
              : null,
            '' !== planesJson[b]['Legales Plan'] &&
              0 < c.getElementsByClassName('js__url-legales-plan').length &&
              (c.getElementsByClassName('js__url-legales-plan')[0].href =
                planesJson[b]['Legales Plan']),
            '' !== planesJson[b]['Legales Promocion'] &&
              ...
              (c.getElementsByClassName('js__url-legales-promo')[0].href =
                planesJson[b]['Legales Promocion']),
            '' !== planesJson[b]['Capacidad Plan Anterior'] &&
            0 < c.getElementsByClassName('js__plan-gigas-antes').length
              ? ((c.getElementsByClassName(
                  'js__plan-gigas-antes-numero',
                )[0].innerHTML = formatoDatosAntes(
                  planesJson[b]['Capacidad Plan Anterior'],
                  planesJson[b]['Unidad Capacidad'],
                )),
            ...
            0 < c.getElementsByClassName('js__plan-data-attributes').length
              ? (c
                ...
                c
                  .getElementsByClassName('js__plan-data-attributes')[0]
                  .setAttribute('data-nombre-landing', nombreLP))
              : null,
            ...
            0 < c.getElementsByClassName('js-minutos-compania').length
              ...
              : null,
            'Si' === planesJson[b].Roaming &&
            0 < c.getElementsByClassName('js-roaming-gratis-mundial').length
              ? (c.getElementsByClassName('js-roaming-gratis-mundial')[0].style.display = 'block')
              : null,
            'Si' === planesJson[b].LlamadasMovistar &&
            0 < c.getElementsByClassName('js-minutos-operador').length
              ? (c.getElementsByClassName('js-minutos-operador')[0].style.display = 'block')
              : null,
            'Si' === planesJson[b].MensajesMovistar &&
            0 < c.getElementsByClassName('js-extra-mensajea').length
              ? (c.getElementsByClassName('js-extra-mensajea')[0].style.display = 'block')
              : null,
            'Si' === planesJson[b].Whatsapp &&
            0 < c.getElementsByClassName('js-extra-whatsapp').length
            ...
            '' !== planesJson[b].Extra && 0 < c.getElementsByClassName('js-beneficio-extra').length
              ? ((c.getElementsByClassName('js-beneficio-extra')[0].style.display = 'block'),
                (c.getElementsByClassName('js-beneficio-extra-copy')[0].innerHTML =
                  planesJson[b].Extra))
              : null,
            'Si' === planesJson[b].TestDrive &&
            0 < c.getElementsByClassName('js-capacidad-navegaci\xF3n-extra').length
              ? (c.getElementsByClassName('js-capacidad-navegaci\xF3n-extra')[0].style.display =
                  'block')
              : null,
            'Si' === planesJson[b].FamiliaMovistar &&
            0 < c.getElementsByClassName('js-planes-familia-movistar').length
              ? (c.getElementsByClassName('js-planes-familia-movistar')[0].style.display = 'block')
              : null;
        }
  }

  function activarDataCallMeBack() {
    var tabPortaClass = '.js__portabilidad';
    var tabplanesMovilesClass = '.js__planes-moviles';
    var tabInternetHogarClass = '.js__internet-hogar';
    var tabEquiposClass = '.js__equipos';
    var callMeDataAttr = 'data-activate-call-me-back';
    var tabPorta = document.querySelectorAll(tabPortaClass)[0];
    var tabplanesMoviles = document.querySelectorAll(tabplanesMovilesClass)[0];
    var tabInternetHogar = document.querySelectorAll(tabInternetHogarClass)[0];
    var tabEquipos = document.querySelectorAll(tabEquiposClass)[0];
    for (var a = 0; a < planesJson.length; a++) {
      if ('3' === planesJson[a]['ID'] && 'SI' === planesJson[a]['Boton 0800'] && tabPorta) {
        tabPorta.setAttribute(callMeDataAttr, 'true');
      }
      if ('6' === planesJson[a]['ID'] && 'SI' === planesJson[a]['Boton 0800'] && tabplanesMoviles) {
        tabplanesMoviles.setAttribute(callMeDataAttr, 'true');
      }
      if (
        '13' === planesJson[a]['ID'] &&
        'SI' === planesJson[a]['Boton 0800'] &&
        tabInternetHogar
      ) {
        tabInternetHogar.setAttribute(callMeDataAttr, 'true');
      }
      if ('60' === planesJson[a]['ID'] && 'SI' === planesJson[a]['Boton 0800'] && tabEquipos) {
        tabEquipos.setAttribute(callMeDataAttr, 'true');
      }
    }
  }

  function mostrar0800() {
    var activeTab = document.querySelector('.tabsNav.active');
    var llamarFlotante = document.querySelectorAll('.js-llamar-flotante');
    var botoneraMobile = document.querySelectorAll('.botonera-mobile');
    var contactWrapper = document.querySelectorAll('.contactWrapper');
    var modalPhone = document.querySelectorAll('.js-modal-phone-container');
    var flotanteDisp = document.querySelectorAll('.Llamar-FlotanteDisponibilidad');
    if ('true' !== activeTab.getAttribute('data-activate-call-me-back')) {
      applyDisplay(llamarFlotante, 'none');
      applyDisplay(botoneraMobile, 'none');
      applyDisplay(contactWrapper, 'none');
      applyDisplay(modalPhone, 'none');
      applyDisplay(flotanteDisp, 'none');
    } else {
      applyDisplay(modalPhone, 'block');
      applyDisplay(contactWrapper, 'block');
      applyDisplay(llamarFlotante, 'block');
    }

    function applyDisplay(object, style) {
      for (var a = 0; a < object.length; a++) {
        object[a].style.display = style;
      }
    }
  }
    ...
    e = function () {
      ...
      if (!isNaN(parseInt(a)))
        b.forEach(function (b) {
          b.classList.remove('js__id-plan-'),
            (b.className = 'js__id-plan-' + a + ' ' + b.className);
        }),
