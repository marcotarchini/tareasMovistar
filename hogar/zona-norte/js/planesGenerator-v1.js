...
$(function () {
  ...
  function activarDataCallMeBack() {
    var tabAdslClass = '.js__adsl';
    var _callMeDataAttr = 'data-activate-call-me-back';
    var tabAdsl = document.querySelectorAll(tabAdslClass)[0];
    for (var a = 0; a < planesJson.length; a++) {
      if ('11' === planesJson[a]['ID'] && 'SI' === planesJson[a]['Boton 0800'] && tabAdsl) {
        tabAdsl.setAttribute(_callMeDataAttr, 'true');
      }
    }
  }
