...
$(function () {
  ...
  function openDisponibilidad(a) {
    switch (($('.js-loquiero-movil-cerrado').hide(), a)) {
      case 'fija':
        ...
        $(_llamarFlotante).hide(), $('.botonera-mobile .botonera-mobile-wrapper').show(), $('.contactWrapper').show();
        break;
      case 'movil':
        //$('.Llamar-FlotanteDisponibilidad').hide(),
        $(_llamarFlotante).show(), $('.botonera-mobile .botonera-mobile-wrapper').show(), $('.contactWrapper').show();
        break;
  ...
  $('.menu-tab').on('shown.bs.tab', function (a) {
    ...
    $(document).on('click', '*[data-target="#modal"],*[data-target="#modalDisponibilidad"]', function (a) {
      var b,
